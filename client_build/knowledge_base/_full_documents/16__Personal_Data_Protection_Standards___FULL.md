...
Source: 16__Personal_Data_Protection_Standards_.docx
Document_Title: 16__Personal_Data_Protection_Standards_
...
```mermaid
graph TD
    A[Start] --> B[Is IT division?]
    B --> |Yes| C[Includes Technology Operation Division?]
    C --> |Yes| D[Includes Governance & Control?]
    D --> |Yes| E[Includes Delivery Transformation Division?]
    E --> |Yes| F[Includes Core Organization?]
    F --> |Yes| G[Leads to Enterprise Data Management & Governance Division?]
    G --> |Yes| H[End]
    B --> |No| H
    C --> |No| H
    D --> |No| H
