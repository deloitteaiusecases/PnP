...
Source: 9__Data_Sharing_and_Interoperability_____14_.docx
Document_Title: 9__Data_Sharing_and_Interoperability_____14_
...
NDMO Domains (alongside BO, DWH, Data Governance, TOD, ETD, CISD, Risk)
...
| Step Number | Description                        | Decision Point | Next Step Yes/No  |
|-------------|------------------------------------|----------------|-------------------|
| 1           | Figure                             | No             | 2                 |
| 2           | Data Governance Operating Model    | No             | End               |

### Mermaid Diagram

```mermaid
graph TD;
    A[Figure] --> B[Data Governance Operating Model];
```
```
...
```mermaid
graph TD
    A[Step 1: Identify Technology Operation Division, Governance & Control, Delivery Transformation Division, Core] --> B[Step 2: Organization]
    B --> C[Step 3: Enterprise Data Management & Governance Division]
```