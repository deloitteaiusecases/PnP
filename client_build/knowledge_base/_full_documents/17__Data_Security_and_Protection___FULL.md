...
Source: 17__Data_Security_and_Protection_.docx
Document_Title: 17__Data_Security_and_Protection_
...
| Step | Description                          | Decision Point | Action for Yes | Action for No |
|------|--------------------------------------|----------------|----------------|---------------|
| 1    | Figure                               | No             | N/A            | N/A           |
| 2    | Number 2                             | No             | N/A            | N/A           |
| 3    | Data Governance Operating Model      | No             | N/A            | N/A           |
...
```mermaid
graph TD;
    A1[IT includes Technology Operation Division, Governance & Control, Delivery Transformation Division, Core] --> B1[Organization];
    B1 --> C1[Division and Enterprise Data Management & Governance Division];
```