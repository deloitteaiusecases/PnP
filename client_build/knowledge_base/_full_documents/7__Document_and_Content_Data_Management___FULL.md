...
| Step | Description                       | Decision     | Next Step if Yes | Next Step if No |
|------|-----------------------------------|--------------|------------------|-----------------|
| 1    | Figure                            | No decision  | 2                | -               |
| 2    | 2                                 | No decision  | 3                | -               |
| 3    | Data Governance Operating Model   | No decision  | -                | -               |
...
```mermaid
graph TD
    A[Start] --> B[IT* includes Technology Operation Division,<br> Governance & Control, Delivery Transformation Division, Core]
    B --> C[Organization]
    C --> D[ing Division and Enterprise Data Management & Governance Division]